...
As such, LOL has established "Moonshot Projects". This program foments technology research which may lead to phase changes in distributed systems, applied cryptography, replicated state machines, and other blockchain topics

Successful deployment of the program would mean that the 0L network would have a leadership role in the industry and have an advantage at incorporating leading edge technologies.
